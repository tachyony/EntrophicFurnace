...
public class EntityDropParticleFX extends EntityFX {
	...
	public void onUpdate() {
		...
		if (material.isLiquid() || material.isSolid()) {
            ...
            double d0 = (float)(MathHelper.floor_double(this.posY) + 1) - BlockFluid.getFluidHeightPercent(this.worldObj.getBlockMetadata(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)));
			if (this.posY < d0) {
				this.setDead();
			}
		}
