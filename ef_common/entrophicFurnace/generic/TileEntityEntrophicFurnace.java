...
public class TileEntityEntrophicFurnace extends TileEntityElectricityStorage implements IElectricityStorage, IPacketReceiver, ISidedInventory
{
    ...
    public long getWatts(int slot)
    {
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 4;
        } else if (this.containingItems[slot].isItemEqual(new ItemStack(Item.feather, 1, 3)))
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 5;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 6;
	    } else if (this.containingItems[slot].isItemEqual(new ItemStack(Item.netherStalkSeeds, 1, 3))
	            || this.containingItems[slot].isItemEqual(new ItemStack(Block.stoneOvenIdle))
	    ...
	    {
	        watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 8;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 16;
        } 
	    else if (this.containingItems[slot].isItemEqual(new ItemStack(Item.gunpowder)))
	    {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 24;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 32;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 40;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 48;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 64;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 128;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 2496;
        } else if (this.containingItems[slot].isItemEqual(new ItemStack(EntrophicFurnace.entrophicOre5)))
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 4096;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 8192;
        } else if (this.containingItems[slot].isItemEqual(new ItemStack(EntrophicFurnace.entrophicPaxel)))
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 9216;
        ...
        {
            watts = TileEntityEntrophicFurnace.WATTS_MULTIPLE * 18176;
        } else
        {
        ...
        return watts * SMELTING_TIME_REQUIRED;
    }
